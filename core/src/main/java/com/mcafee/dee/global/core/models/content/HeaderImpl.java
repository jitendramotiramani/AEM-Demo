...
import com.mcafee.dee.global.core.models.Header;
...
@Model(adaptables = Resource.class, adapters = Header.class, resourceType = HeaderImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")
public class HeaderImpl implements Header {
 
    protected static final String RESOURCE_TYPE = "mcafee/components/content/header";
    ...
    private NavigationItem createNavItem(Resource resource) {
        ...
        if(StringUtils.isNotBlank(url)) {
            ...
            NavigationItem navItem = new NavigationItemImpl(navPage, isActive, isHierarchyActive, url, text);
            return navItem;
        }
